...
const menuItems = [
  ...
  { href: "/dev-plus-plus", icon: PlusSquare, label: "DEV++", color: "gray-600" },
  ...
  { href: "/dev-help", icon: HelpCircle, label: "DEV Help", color: "yellow-300" },
  { href: "/forem-shop", icon: ShoppingCart, label: "Forem Shop", color: "purple-500" },
  { href: "/advertise-on-dev", icon: Heart, label: "Advertise on DEV", color: "red-500" },
  { href: "/dev-challenges", icon: Trophy, label: "DEV Challenges", color: "yellow-500" },
  { href: "/dev-showcase", icon: Star, label: "DEV Showcase", color: "yellow-300" },
  { href: "/about", icon: Info, label: "About", color: "gray-600" },
  { href: "/contact", icon: PhoneCall, label: "Contact", color: "gray-600" },
  { href: "/free-postgres-database", icon: Database, label: "Free Postgres", color: "gray-600" },
  { href: "/guides", icon: BookOpen, label: "Guides", color: "gray-600" },
];

const otherMenuItems = [
    { href: "/code-of-conduct", icon: ThumbsUp, label: "Code of Conduct", color: "gray-600" },
    { href: "/privacy-policy", icon: User, label: "Privacy Policy", color: "gray-600" },
    { href: "/terms-of-use", icon: Eye, label: "Terms of Use", color: "gray-600" },
];
